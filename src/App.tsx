      ...
      <Routes>
        ...
        <Route path="*" element={
          <main className="min-h-[60vh] flex flex-col items-center justify-center text-center px-6">
            <p className="font-display text-7xl font-semibold text-primary-purple">404</p>
            <p className="mt-2 text-ink/65">No encontramos esta página.</p>
            <a href="/" className="mt-6 text-primary-purple font-semibold underline underline-offset-4">Volver al inicio</a>
          </main>
        } />
      </Routes>
