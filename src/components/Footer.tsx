    ...
    <footer className="bg-plum text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-4xl font-semibold text-white">MRA <span className="text-primary-gold text-2xl">Óptica</span></h2>
          <p className="text-purple-200 text-sm leading-relaxed">
            Tu óptica de confianza en Rionegro, Antioquia. Salud visual de calidad con atención personalizada.
          </p>
          <div className="flex gap-4 mt-2">
            <a
              href="https://instagram.com/@mraoptespecializada04"
              target="_blank"
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-primary-gold font-semibold text-sm mb-1">
            Navegar
          </h3>
          {[
            { label: 'Inicio',            to: '/'          },
